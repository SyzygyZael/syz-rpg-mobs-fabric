...
public class OrchidManeaterAttackGoal extends MeleeAttackGoal {
    private final OrchidManeaterEntity entity;
    private int attackDelay = 10;
    private int ticksUntilNextAttack = 20;
    private boolean shouldCountTillNextAttack = false;

    public OrchidManeaterAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((OrchidManeaterEntity) mob);
    }
    ...
    private boolean isEnemyWithinAttackDistance(LivingEntity pEnemy) {
        return this.mob.squaredDistanceTo(pEnemy) < 12f;
    }
