...
public class CobbleProjectileModel extends EntityModel<CobbleProjectileRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData bb_main = modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(0, 4).cuboid(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 24.0F, 0.0F, 0.0F, 0.0F, 0.0F));
