...
public class CrystallineMagmiteModel extends EntityModel<CrystallineMagmiteRenderState> {
	...
	public CrystallineMagmiteModel(ModelPart root) {
		...
		this.walkAnimation = CrystallineMagmiteAnimations.crystilline_magmite_walk.createAnimation(root);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData crystalline_magmite = modelPartData.addChild("crystalline_magmite", ModelPartBuilder.create(), ModelTransform.of(0.0F, 24.0F, 0.0F, 0.0F, 0.0F, 0.0F));

		ModelPartData head = crystalline_magmite.addChild("head", ModelPartBuilder.create().uv(64, 45).cuboid(-4.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -45.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		...
		ModelPartData torso = crystalline_magmite.addChild("torso", ModelPartBuilder.create().uv(0, 82).cuboid(-4.0F, -6.0F, -2.0F, 7.0F, 2.0F, 6.0F, new Dilation(0.0F))
				...
				.uv(0, 0).cuboid(-9.0F, -19.0F, -4.0F, 17.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -26.0F, 0.0F, 0.0F, 0.0F, 0.0F));

		ModelPartData left_arm = crystalline_magmite.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.of(-1.0F, -42.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		...
		ModelPartData right_arm = crystalline_magmite.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.of(-1.0F, -41.0F, -2.0F, 0.0F, 0.0F, 0.0F));
		...
		ModelPartData waist = crystalline_magmite.addChild("waist", ModelPartBuilder.create().uv(64, 36).cuboid(-4.0F, -3.0F, -2.0F, 9.0F, 4.0F, 5.0F, new Dilation(0.0F))
				.uv(88, 64).cuboid(-3.0F, 1.0F, -2.0F, 7.0F, 2.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, -23.0F, 0.0F, 0.0F, 0.0F, 0.0F));
