package net.syzygy.rpgmobs.entity.client.TwistedTreantComponents.TwistedTreant;// Save this class in your mod and generate all required imports
...
public class TwistedTreantAnimations {
	...
	public static final AnimationDefinition walking_animation = AnimationDefinition.Builder.create(0.9167F).looping()
	...
	public static final AnimationDefinition attack_animation_1 = AnimationDefinition.Builder.create(1.0F)
		.addBoneAnimation("head", new Transformation(Transformation.Targets.MOVE_ORIGIN,
			new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
	...
	public static final AnimationDefinition attack_animation_2 = AnimationDefinition.Builder.create(1.0F)
	...
	public static final AnimationDefinition stand_up_animation = AnimationDefinition.Builder.create(3.5F)
		.addBoneAnimation("head", new Transformation(Transformation.Targets.MOVE_ORIGIN,
			new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
