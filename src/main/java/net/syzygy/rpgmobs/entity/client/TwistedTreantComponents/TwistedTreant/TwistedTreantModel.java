...
public class TwistedTreantModel extends EntityModel<TwistedTreantRenderState> {
	...
	private final Animation idleAnimaiton;
	...
	public TwistedTreantModel(ModelPart root) {
        ...
        this.walkingAnimation = TwistedTreantAnimations.walking_animation.createAnimation(root);
        this.idleAnimaiton = TwistedTreantAnimations.idle_animation.createAnimation(root);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(50, 68).cuboid(-4.0F, -6.0F, -4.0F, 8.0F, 5.0F, 7.0F, new Dilation(-0.6F)), ModelTransform.rotation(0.0F, -22.0F, -7.0F));
		...
		ModelPartData right_arm = main.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.rotation(-6.0F, -22.0F, -4.0F));

		ModelPartData right_forearm = right_arm.addChild("right_forearm", ModelPartBuilder.create().uv(52, 40).cuboid(-2.0F, 8.9526F, -4.5671F, 5.0F, 2.0F, 6.0F, new Dilation(-0.01F)), ModelTransform.rotation(-3.0F, 11.0F, -1.0F));
		...
		ModelPartData right_elbow = right_forearm.addChild("right_elbow", ModelPartBuilder.create(), ModelTransform.rotation(0.0F, -3.0F, 8.0F));
		...
		ModelPartData right_spike_in_hand = right_forearm.addChild("right_spike_in_hand", ModelPartBuilder.create(), ModelTransform.rotation(1.0F, 9.0F, 0.0F));
		...
		ModelPartData right_spike = upper_right_arm.addChild("right_spike", ModelPartBuilder.create(), ModelTransform.rotation(-7.0F, 5.0F, 7.0F));
		...
		ModelPartData left_arm = main.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.rotation(6.0F, -22.0F, -4.0F));

		ModelPartData left_forearm = left_arm.addChild("left_forearm", ModelPartBuilder.create().uv(52, 32).cuboid(-3.0F, 8.9526F, -4.5671F, 5.0F, 2.0F, 6.0F, new Dilation(-0.01F)), ModelTransform.rotation(3.0F, 11.0F, -1.0F));
		...
		ModelPartData left_elbow = left_forearm.addChild("left_elbow", ModelPartBuilder.create(), ModelTransform.rotation(0.0F, -3.0F, 8.0F));
		...
		ModelPartData left_spike_in_hand = left_forearm.addChild("left_spike_in_hand", ModelPartBuilder.create(), ModelTransform.rotation(-1.0F, 9.0F, 2.0F));
		...
		ModelPartData left_spike = left_upper_arm.addChild("left_spike", ModelPartBuilder.create(), ModelTransform.rotation(6.0F, 5.0F, 8.0F));
		...
		ModelPartData torso = main.addChild("torso", ModelPartBuilder.create(), ModelTransform.rotation(0.0F, -17.0F, 3.0F));
		...
		ModelPartData waist = main.addChild("waist", ModelPartBuilder.create(), ModelTransform.rotation(0.0F, -17.0F, 2.0F));
		...
		ModelPartData right_leg = main.addChild("right_leg", ModelPartBuilder.create().uv(22, 51).cuboid(-2.0F, 9.0F, -3.0F, 5.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.rotation(-5.0F, -14.0F, 7.0F));
		...
		ModelPartData left_leg = main.addChild("left_leg", ModelPartBuilder.create().uv(42, 51).cuboid(-3.0F, 9.0F, -3.0F, 5.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.rotation(5.0F, -14.0F, 7.0F));
    ...
    public void setAngles(TwistedTreantRenderState state) {
        ...
        this.idleAnimaiton.apply(state.idleAnimationState, state.age, 1f);
        ...
        this.standUpAnimation.apply(state.standUpAnimationState, state.age, 1f);
    }
