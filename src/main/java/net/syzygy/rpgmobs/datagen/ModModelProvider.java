...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.CRYSTALLINE_MAGMITE_HELMET, Models.GENERATED);
        itemModelGenerator.register(ModItems.CRYSTALLINE_MAGMITE_CHESTPLATE, Models.GENERATED);
        itemModelGenerator.register(ModItems.CRYSTALLINE_MAGMITE_LEGGINGS, Models.GENERATED);
        itemModelGenerator.register(ModItems.CRYSTALLINE_MAGMITE_BOOTS, Models.GENERATED);

        itemModelGenerator.register(ModItems.SHARD_BLADE, Models.HANDHELD);
        itemModelGenerator.register(ModItems.DEMONIC_BLADE, Models.HANDHELD);
        itemModelGenerator.register(ModItems.STAFF_OF_THE_FOREST_MONARCH, Models.HANDHELD);
    }
}
